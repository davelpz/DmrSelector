    ...
    window.ccDmrSelector = ccDmrSelector = (function () {
            ...
            if (this.options.dmr_list.length === 0) {
                ...
                for (i = 0, _len = _ref.length; i < _len; i++) {
                    ...
                    tempDiv = ($('<tr/>')).attr({
                        ...
                        title: this.options.dmr_list[i].account_name.toUpperCase()
                    }).attr({
                        name: i + 1
        ...
        ccDmrSelector.prototype._init = function () {
            ...
            element.find('.' + this.css.SinglePanelArrowBase).click(function (event) {
                ...
                return ($(me.element)).find('.' + me.css.SearchInputBox)[0].value = '';
            });
            ...
            element.find('.' + this.css.SearchInputBox).change(function (event) {
                if (this.value !== '') {
                    return me.Search(this.value.toUpperCase());
                } else {
            ...
            element.find('.' + this.css.SearchIcon).change(function (event) {
                if (this.value !== '') {
                    return me.Search(this.previousSibling.value.toUpperCase());
                } else {
                    return me.SwitchtoSelector(me.options.Default);
                }
            });
        ...
        ccDmrSelector.prototype.Search = function (SearchWord) {
            ...
            if (($(this.element[0].children[1].children[1].children[0].children[2].children[0])).find('tr[title*="' + SearchWord + '"]').length === 0) {
                ...
                return ($(this.element[0].children[1].children[1].children[0].children[2].children[0])).find('tr[title*="' + SearchWord + '"]').attr({
                    style: "display:block"
                });
            }
        };
